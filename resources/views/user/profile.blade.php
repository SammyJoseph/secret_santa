        ...
        <div class="max-w-4xl w-full space-y-8 p-10 bg-white rounded-xl shadow-lg z-10">
            <div class="grid gap-8 grid-cols-1 md:grid-cols-2">
                ...
                <div class="flex flex-col items-center space-y-6">
                    ...
                    <div class="w-3/4 aspect-square bg-gray-300 rounded-lg flex items-center justify-center">
                    ...
                    <form action="{{ route('user.update', $user) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form">
                            ...
                            <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                <button type="submit" class="mb-2 md:mb-0 bg-[#146B3A] px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-800">Actualizar Perfil</button>
                            </div>
                        </div>
                    </form>
                </div>
