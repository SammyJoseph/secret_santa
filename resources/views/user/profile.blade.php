                            ...
                            <div class="form">
                                ...
                                <div class="lg:flex flex-row lg:space-x-4 w-full text-xs">
                                    <div class="space-y-2 w-full text-xs mb-3 lg:mb-0">
                                        ...
                                        <input placeholder="Nombre" class="appearance-none block w-full bg-gray-50 border border-gray-200 rounded-lg h-10 px-4 text-sm focus:ring-1 focus:ring-[#F8B229] focus:border-[#F8B229] focus:outline-none placeholder-gray-400" required="required"
